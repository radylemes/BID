...
async function gravarAuditoria(
  ...
  try {
    ...
    await logErro("POINTS_RULE_CONTROLLER_GRAVAR_AUDITORIA", e);
  }
}
...
exports.getRules = async (req, res) => {
  try {
    ...
    await logErro("POINTS_RULE_CONTROLLER_GET_RULES", error);
...
exports.createRule = async (req, res) => {
  ...
  try {
    ...
    const [result] = await connection.execute(
      `INSERT INTO regras_pontuacao (descricao, pontos, frequencia_valor, frequencia_tipo, grupo_id, perfil_alvo, setor_id, somente_ativos, proxima_execucao) VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW())`,
      [
        descricao,
        pontos,
        frequencia_valor,
    ...
    await logErro("POINTS_RULE_CONTROLLER_CREATE_RULE", error);
...
exports.updateRule = async (req, res) => {
  ...
  try {
    ...
    await connection.execute(
      `UPDATE regras_pontuacao SET descricao = ?, pontos = ?, frequencia_valor = ?, frequencia_tipo = ?, grupo_id = ?, perfil_alvo = ?, setor_id = ?, somente_ativos = ? WHERE id = ?`,
      [
        descricao,
        pontos,
        frequencia_valor,
    ...
    await connection.rollback();
    await logErro("POINTS_RULE_CONTROLLER_UPDATE_RULE", error);
...
exports.toggleRule = async (req, res) => {
  ...
  try {
    ...
    await connection.rollback();
    await logErro("POINTS_RULE_CONTROLLER_TOGGLE_RULE", error);
...
exports.deleteRule = async (req, res) => {
  ...
  try {
    ...
    await connection.rollback();
    await logErro("POINTS_RULE_CONTROLLER_DELETE_RULE", error);
